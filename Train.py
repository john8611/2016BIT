...
sys.path.append("/home/kimsy/mxnet/python") 
...
systole_model_prefix = 'test_systole_model'
iteration = 100
systole_model.save(systole_model_prefix, iteration)
...
diastole_model_prefix = 'test_diastole_model'
iteration = 100
diastole_model.save(diastole_model_prefix, iteration)
# # Predict diastole
